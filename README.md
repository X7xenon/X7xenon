...
[![Email](https://img.shields.io/badge/Direct-kumarabeer007@gmail.com-00E676?style=for-the-badge&logo=gmail&logoColor=white)](mailto:kumarabeer007@gmail.com)
...
<p align="center">
  <b>Architecting sovereign AI systems, multi-agent debate protocols, and real-time generative media pipelines.</b><br/>
  <i>Obsessed with low-latency runtimes, zero-cloud data custody, and tactile hardware-software synthesis.</i>
</p>
...
| :--- | :--- |
| **Languages & Runtimes** | `Python` `Rust` `Kotlin` `TypeScript` `JavaScript` `SQL` `Bash` `C++` |
| **AI / ML & Agents** | `Gemini Live & Interactions` `OpenAI Whisper` `YOLOv8` `PyTorch` `LangGraph` `MCP` |
| **Frameworks & UI** | `FastAPI` `Tauri v2` `Jetpack Compose` `Android Glance` `React 18` `Vite` `TailwindCSS` |
| **Data & Storage** | `SQLite (WAL / FTS5)` `Room v3` `Vector Embeddings` `Obsidian Markdown Vaults` |
| **Hardware & Native** | `Nothing Phone Glyph AIDL IPC` `OpenCV Face Tracking` `Gimbal Motor Control` `FFmpeg` |
